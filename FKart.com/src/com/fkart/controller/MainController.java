...
public class MainController {
	private static IAdminServices productService = new AdminServicesImpl();
	...
	private static void putSomeValues() {
		...
		Date date8 = date.getDate("01-12-2022");
		...
		Customer c1 = new Customer(1001, "Vaibhav Saini", "vaibhav.mahar@gmail.com", 7011658967L,
				"C1/91, vijay enclave");
		Customer c2 = new Customer(2002, "Rahul Singh", "rahulSingh@gmail.com", 7015324632L, "R2-23, raja puri");
